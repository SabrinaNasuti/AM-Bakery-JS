...
if ((usuario == "Sabrina") || (usuario == "sabrina")) {
  console.log("Binvenida Sabrina, te extrañamos!. ")
}
...
const montoFiltro = parseInt(prompt("Por favor ingrese el valor a filtrar o cero para continuar")); 

if(montoFiltro != 0){
  const filtro = catalogoCompleto.filter((producto) => producto.precio > montoFiltro);
...
function elegirproducto() {
  producto1 = prompt(`Ingrese el número del producto deseada comprar o 0 para terminar: 
1 - Macarons;
2 - Torta Fantasía;
3 - Torta Marroc;
4 - CheeseCake;
