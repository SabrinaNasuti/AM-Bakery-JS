...
console.log("Bienvenido a AM Bakery")
...
function control(producto1) {
  if ((producto1 == "1") || (producto1 == "2") || (producto1 == "3") ||
    (producto1 == "4") || (producto1 == "5")) {
...
function calculoMontoProducto(nombreProducto, cantidad, precioProducto) {
  ...
  console.log(`El monto total + IVA de ${nombreProducto} es: $ ${montoTotalPorProducto}`)
